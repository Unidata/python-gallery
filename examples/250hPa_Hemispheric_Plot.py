...
# Latest GFS Dataset
cat = TDSCatalog('http://thredds.ucar.edu/thredds/catalog/grib/NCEP/GFS/Global_0p5deg/latest.xml')
...
wspd250 = np.sqrt(u250**2. + v250**2.)*1.94384
...
ax.set_title('VALID: %s' %(vtimes[0]),loc='right')
...
gs.tight_layout(fig)
#plt.savefig('250_hemis_plot.png',dpi=150)
plt.show()
